...
from ext_list import dict_operations
from ext_list import general_operators
from ext_list import list_operations
...
class ExtList(List[T]):
    ...
    def extract(self, key: FunctionType | property | str | Hashable, *args: Any) -> ExtList[Any]:
        ...
        Examples:
            ...
            [20, 25, 30]
        """
        return ExtList(list_operations.extract(self, key, *args))
    ...
    def extract_duplicates(self, other: ExtList[T]) -> ExtList[T]:
        ...
        Examples:
            ...
            [{'name': 'Bob', 'age': 30}]
        """
        return ExtList(list_operations.extract_duplicates(self, other))
    ...
    def is_duplicate(self) -> bool:
        ...
        Examples:
            ...
            False
        """
        return list_operations.is_duplicate(self)
    ...
    def one(self) -> T | None:
        ...
        Examples:
            ...
            None
        """
        return list_operations.one(self)
    ...
    def first(self) -> T:
        ...
        Examples:
            ...
            1
        """
        return list_operations.first(self)
    ...
    def equal(self, key: FunctionType | property | str | Hashable, compare_target: Any, *args: Any) -> ExtList[T]:
        ...
        Examples:
            ...
            [Person('Alice', 25)]
        """
        return ExtList(general_operators.equal(self, key, compare_target, *args))
    ...
    def not_equal(self, key: FunctionType | property | Hashable, compare_target: Any, *args: Any) -> ExtList[T]:
        ...
        Examples:
            ...
            [Person('Bob', 30), Person('Charlie', 35), Person('David', 30)]
        """
        return ExtList(general_operators.not_equal(self, key, compare_target, *args))
    ...
    def greater(self, key: FunctionType | property | Hashable, compare_target: Any, *args: Any) -> ExtList[T]:
        ...
        Examples:
            ...
            [Person('Charlie', 35)]
        """
        return ExtList(general_operators.greater(self, key, compare_target, *args))
    ...
    def greater_or_equal(self, key: FunctionType | property | Hashable, compare_target: Any, *args: Any) -> ExtList[T]:
        ...
        Examples:
            ...
            [Person('Bob', 30), Person('Charlie', 35), Person('David', 30)]
        """
        return ExtList(general_operators.greater_or_equal(self, key, compare_target, *args))
    ...
    def less(self, key: FunctionType | property | Hashable, compare_target: Any, *args: Any) -> ExtList[T]:
        ...
        Examples:
            ...
            [Person('Alice', 25)]
        """
        return ExtList(general_operators.less(self, key, compare_target, *args))
    ...
    def less_or_equal(self, key: FunctionType | property | Hashable, compare_target: Any, *args: Any) -> ExtList[T]:
        ...
        Examples:
            ...
            [Person('Alice', 25), Person('Bob', 30), Person('David', 30)]
        """
        return ExtList(general_operators.less_or_equal(self, key, compare_target, *args))
    ...
    def in_(self, key: FunctionType | property | str | Hashable, compare_target: list[Any], *args: Any) -> ExtList[T]:
        ...
        Examples:
            ...
            [Person('Alice', 25), Person('Charlie', 35)]
        """
        return ExtList(general_operators.in_(self, key, compare_target, *args))
    ...
    def not_in_(self, key: FunctionType | property | str | Hashable, compare_target: list[Any], *args: Any) -> ExtList[T]:
        ...
        Examples:
            ...
            [Person('Bob', 30)]
        """
        return ExtList(general_operators.not_in_(self, key, compare_target, *args))
    ...
    def to_dict(self, key: FunctionType | property | str | Hashable, *args: Any) -> dict[Hashable, T]:
        ...
        """
        return dict_operations.to_dict(self, key, *args)
    ...
    def to_dict_list(self, keys: list[FunctionType | property | str | Hashable], arg_tuples: list[tuple[Any, ...]] = []) -> ExtList[dict[str | Hashable, Any]]:
        ...
        """
        return ExtList(dict_operations.to_dict_list(self, keys, arg_tuples))
    ...
    def to_dict_with_complex_keys(self, keys: list[FunctionType | property | str] | list[Hashable], arg_tuples: list[tuple[Any, ...]] = []) -> dict[tuple[Any, ...], T]:
        ...
        """
        return dict_operations.to_dict_with_complex_keys(self, keys, arg_tuples)
    ...
    def dicts_to_instances(self: ExtList[dict[str, Any]], type_: TI) -> ExtList[TI]:
        ...
        """
        return ExtList(dict_operations.dicts_to_instances(self, type_))
    ...
    def group_by_key(self, key: FunctionType | property | str | Hashable, *args: Any) -> dict[Hashable, ExtList[T]]:
        ...
        """
        return dict_operations.group_by_key(ExtList, self, key, *args)  # type: ignore[assigment]
    ...
    def rename_keys(self, rename_keys: dict[Hashable, Hashable]) -> ExtList[T]:
        ...
        Examples:
            ...
            [{'Name': 'alice', 'Age': 25}, {'Name': 'bob', 'Age': 30}]
        """
        return ExtList(dict_operations.rename_keys(self, rename_keys))
